...
export interface Battery4BarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

const Battery4BarIcon = ({ size, ...props }: Battery4BarIconProps) => {
  return (
    <svg
      width={size || "1em"}
      height={size || "1em"}
