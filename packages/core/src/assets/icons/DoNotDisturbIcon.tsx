...
export interface DoNotDisturbIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

const DoNotDisturbIcon = ({ size, ...props }: DoNotDisturbIconProps) => {
  return (
    <svg
      width={size || "1em"}
      height={size || "1em"}
