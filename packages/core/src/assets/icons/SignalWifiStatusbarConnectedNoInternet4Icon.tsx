...
const SignalWifiStatusbarConnectedNoInternet4Icon = ({ size, ...props }: SignalWifiStatusbarConnectedNoInternet4IconProps) => {
  return (
    <svg
      width={size || "1em"}
      height={size || "1em"}
...
<path d="M13.0625 3.64575C8.17708 3.64575 3.76042 5.62492 0.5625 8.83325L13.0625 21.3541L18.2708 16.1353V7.81242H24.4375C21.3646 5.21867 17.3958 3.64575 13.0625 3.64575Z" fill="currentColor"/>
