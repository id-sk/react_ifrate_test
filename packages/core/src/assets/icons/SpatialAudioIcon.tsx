...
const SpatialAudioIcon = ({ size, ...props }: SpatialAudioIconProps) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M16.1458 2.08337H14.0625C14.0625 7.26046 18.2604 11.4584 23.4375 11.4584V9.37504C19.4167 9.37504 16.1458 6.10421 16.1458 2.08337Z"
        fill="currentColor"
      />
      <path
        d="M20.3125 2.08337H18.2292C18.2292 4.95837 20.5625 7.29171 23.4375 7.29171V5.20837C21.7188 5.20837 20.3125 3.80212 20.3125 2.08337Z"
        fill="currentColor"
      />
    </svg>
  );
