...
export interface AddIcCallIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

const AddIcCallIcon = ({ size, ...props }: AddIcCallIconProps) => {
  return (
    <svg
      width={size || "1em"}
      height={size || "1em"}
