...
<path d="M4.6875 11.979V14.0623H13.0208V11.979H4.6875ZM20.3125 19.2707H18.2292V8.20817L15.1042 9.27067V7.49984L20 5.729H20.3125V19.2707Z" fill="currentColor"/>
    </svg>
  );
};
