...
const CategoryIcon = ({ size, ...props }: CategoryIconProps) => {
  return (
    ...
    >
      ...
      <path
        d="M17.7084 22.9168C20.2972 22.9168 22.3959 20.8182 22.3959 18.2293C22.3959 15.6405 20.2972 13.5418 17.7084 13.5418C15.1196 13.5418 13.0209 15.6405 13.0209 18.2293C13.0209 20.8182 15.1196 22.9168 17.7084 22.9168Z"
        fill="currentColor"
      />
