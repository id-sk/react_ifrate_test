...
<path d="M20.8333 19.7917V3.125H4.16659V19.7917H2.08325V21.875H22.9166V19.7917H20.8333ZM10.4166 19.7917V5.20833H14.5833V19.7917H10.4166Z" fill="currentColor"/>
    </svg>
  );
};
