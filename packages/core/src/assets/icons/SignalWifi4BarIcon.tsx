...
const SignalWifi4BarIcon = ({ size, ...props }: SignalWifi4BarIconProps) => {
  return (
    ...
    >
      <path
        d="M12.5104 22.1249L24.625 7.03117C24.1562 6.677 19.4896 2.8645 12.5 2.8645C5.5 2.8645 0.84375 6.677 0.375 7.03117L12.4896 22.1249L12.5 22.1353L12.5104 22.1249Z"
        fill="currentColor"
      />
    </svg>
  );
