...
export interface TheatersIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

const TheatersIcon = ({ size, ...props }: TheatersIconProps) => {
  return (
    <svg
      width={size || '1em'}
      height={size || '1em'}
