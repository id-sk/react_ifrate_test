...
export interface SettingsPhoneIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

const SettingsPhoneIcon = ({ size, ...props }: SettingsPhoneIconProps) => {
  return (
    <svg
      width={size || "1em"}
      height={size || "1em"}
