...
export interface RepeatOnIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

const RepeatOnIcon = ({ size, ...props }: RepeatOnIconProps) => {
  return (
    <svg
      width={size || "1em"}
      height={size || "1em"}
