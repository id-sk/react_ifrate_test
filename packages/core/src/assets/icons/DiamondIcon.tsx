...
const DiamondIcon = ({ size, ...props }: DiamondIconProps) => {
  return (
    ...
    >
      <path
        d="M12.6667 3.59375H12.3334L9.59383 9.0625H15.4063L12.6667 3.59375Z"
        fill="currentColor"
      />
      <path
        d="M17.1459 9.0625H22.5209L19.7917 3.59375H14.4167L17.1459 9.0625Z"
        fill="currentColor"
      />
      ...
      <path
        d="M7.85425 9.0625L10.5834 3.59375H5.20841L2.47925 9.0625H7.85425Z"
        fill="currentColor"
      />
    </svg>
  );
