...
export interface ScheduleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

const ScheduleIcon = ({ size, ...props }: ScheduleIconProps) => {
  return (
    <svg
      width={size || '1em'}
      height={size || '1em'}
    ...
    >
      ...
      />
      <path
        d="M13.0208 7.29171H11.4583V13.5417L16.927 16.823L17.7083 15.5417L13.0208 12.7605V7.29171Z"
        fill="currentColor"
      />
    </svg>
  );
