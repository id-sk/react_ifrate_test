...
export interface LocalPhoneIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

const LocalPhoneIcon = ({ size, ...props }: LocalPhoneIconProps) => {
  return (
    <svg
      width={size || "1em"}
      height={size || "1em"}
