...
const ReportGmailerrorredIcon = ({ size, ...props }: ReportGmailerrorredIconProps) => {
  return (
    ...
    >
      <path
        d="M16.3854 3.125H8.61458L3.125 8.61458V16.3854L8.61458 21.875H16.3854L21.875 16.3854V8.61458L16.3854 3.125ZM19.7917 15.5208L15.5208 19.7917H9.47917L5.20833 15.5208V9.47917L9.47917 5.20833H15.5208L19.7917 9.47917V15.5208Z"
        fill="currentColor"
      />
