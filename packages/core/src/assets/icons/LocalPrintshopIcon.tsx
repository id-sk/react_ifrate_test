...
export interface LocalPrintshopIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

const LocalPrintshopIcon = ({ size, ...props }: LocalPrintshopIconProps) => {
  return (
    <svg
      width={size || "1em"}
      height={size || "1em"}
